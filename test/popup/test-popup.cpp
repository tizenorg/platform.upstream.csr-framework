...
BOOST_AUTO_TEST_CASE(prompt_data)
{
	...
	Ui::AskUser askuser;
	printPressed(askuser.cs(Ui::CommandId::CS_PROMPT_DATA, "Message for prompt data tc", d));
...
BOOST_AUTO_TEST_CASE(prompt_app)
{
	...
	Ui::AskUser askuser;
	printPressed(askuser.cs(Ui::CommandId::CS_PROMPT_APP, "Message for prompt app tc", d));
...
BOOST_AUTO_TEST_CASE(prompt_file)
{
	...
	Ui::AskUser askuser;
	printPressed(askuser.cs(Ui::CommandId::CS_PROMPT_FILE, "Message for prompt file tc", d));
...
BOOST_AUTO_TEST_CASE(notify_data)
{
	...
	Ui::AskUser askuser;
	printPressed(askuser.cs(Ui::CommandId::CS_NOTIFY_DATA, "Message for notify data tc", d));
...
BOOST_AUTO_TEST_CASE(notify_app)
{
	...
	Ui::AskUser askuser;
	printPressed(askuser.cs(Ui::CommandId::CS_NOTIFY_APP, "Message for notify app tc", d));
...
BOOST_AUTO_TEST_CASE(notify_file)
{
	...
	Ui::AskUser askuser;
	auto response = askuser.cs(Ui::CommandId::CS_NOTIFY_FILE, "Message for notify file tc", d);
...
BOOST_AUTO_TEST_CASE(prompt)
{
	...
	Ui::AskUser askuser;
	printPressed(askuser.wp(Ui::CommandId::WP_PROMPT, "Message for wp_prompt tc", item));
...
BOOST_AUTO_TEST_CASE(notify)
{
	...
	Ui::AskUser askuser;
	printPressed(askuser.wp(Ui::CommandId::WP_NOTIFY, "Message for wp_notify tc", item));
