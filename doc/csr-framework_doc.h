 ...
 * @brief    The CSR (Content Screening & Reputation) framework is Anti-Virus framework. It provides Content Screening Service and Web Protection Service to protect a device and an user.
 *
 ...
 *     <td> Provides APIs managing an underlying anti virus engine.</td>
 *   </tr>
 *   <tr>
 ...
 * </table>
 *
 * The CSR (Content Screening & Reputation) framework is Anti-Virus framework. It provides Content Screening Service and Web Protection Service to protect a device and an user
