 ...
 * \#include <csr-content-scanning.h>
 *
 * @section CAPI_CSR_FRAMEWORK_CS_MODULE_OVERVIEW Overview
 * It provides APIs scanning contents for data, files, and directories to detect malwares. Actual scanning is performed by an underlying anti malware engine which will be provided by a device manufacturer.
 */
