 ...
 * @defgroup CAPI_CSR_FRAMEWORK_ADMIN_MODULE Content Screening Module
 * @brief    It provides APIs managing an underlying anti virus engine.
 *
 ...
 * It provides APIs getting engine information and enabling or disabling an underlying anti virus engine.
 */
