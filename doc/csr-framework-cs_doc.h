 ...
 * It provides APIs scanning contents for data, files, and directories to detect malwares. Actual scanning is performed by an underlying anti virus engine which will be provided by a device manufacturer.
 */
