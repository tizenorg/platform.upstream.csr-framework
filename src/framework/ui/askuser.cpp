...
AskUser::AskUser()
{
	m_dispatcher.reset(new Dispatcher(getSockDesc(SockId::POPUP)));
}
...
csr_cs_user_response_e AskUser::cs(const CommandId &cid,
...
csr_wp_user_response_e AskUser::wp(const CommandId &cid,
								   const std::string &message,
