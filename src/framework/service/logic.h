...
private:
	...
	static csr_cs_user_response_e getUserResponse(const CsContext &, const CsDetected &);
	static csr_wp_user_response_e getUserResponse(const WpContext &, const std::string &url, const WpResult &);
