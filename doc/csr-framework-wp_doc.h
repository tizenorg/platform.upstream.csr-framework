 ...
 * It provides provides APIs checking URL reputation to see if the URL is risky or not. Actual operation is performed by an underlying anti virus engine which will be provided by a device manufacturer.
 */
