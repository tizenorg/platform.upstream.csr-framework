 ...
 * @since_tizen 3.0
 *
 * @remarks A Content Screengin API handle (or CSR CS handle) is obtained using the
...
/**
 * @brief Releases all system resources associated with a Content Screengin API handle.
 *
 * @since_tizen 3.0
 *
