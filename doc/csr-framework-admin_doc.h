 ...
 * @defgroup CAPI_CSR_FRAMEWORK_ADMIN_MODULE CSR Admin Module
 * @brief    It provides APIs managing an underlying anti malware engine.
 *
 ...
 * It provides APIs getting engine information and enabling or disabling an underlying anti malware engine.
 */
